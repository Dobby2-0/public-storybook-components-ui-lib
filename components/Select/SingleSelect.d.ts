 ...
 */
declare const SingleSelect: <T extends object>({ placeholder, className, items, disallowEmptySelection, selectedKey, defaultSelectedKey, onSelectionChange, idResolver, ...props }: SingleSelectProps<T> & ListBoxProps<T>) => import("react/jsx-runtime").JSX.Element;
