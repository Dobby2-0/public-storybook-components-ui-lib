 ...
 */
declare const SingleSelect: <T extends object>({ placeholder, className, items, disallowEmptySelection, value, defaultValue, selectedKey, defaultSelectedKey, onSelectionChange, idResolver, keepSelectionClear, storageKey, ...props }: SingleSelectProps<T> & ListBoxProps<T>) => import("react/jsx-runtime").JSX.Element;
